                    ...
                    .addOnCompleteListener(new OnCompleteListener<Location>() {
                        ...
                        public void onComplete(@NonNull Task<Location> task) {
                            if (task.isSuccessful() && task.getResult() != null) {
                                ...
                                Log.i("CEK_LOKASI_UPDATE", "getLastLocation " + mLocation);
...
//        Toast.makeText(getApplicationContext(), "onNewLocation " + location, Toast.LENGTH_LONG).show();
        ...
        if (this.iLocationProvider != null) {
          ...
          //  save_update_lokasi("tamadioz21@gmail.com",lat.toString(),lang.toString());
        }
    }
...
//    }
//    private void save_update_lokasi(final String email, final String lat,final String lng){
//
//    }
