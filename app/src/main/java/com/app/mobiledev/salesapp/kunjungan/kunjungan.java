...
public class kunjungan extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private String outlet,iduser,id;
    ...
    private void dialog_signature() {
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(kunjungan.this, ""+encodedImage, Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        dialog.show();
    ...
    public void getLokasi(double llat,double llon) {
        ...
        if(llat == 0){
            ...
            Geocoder geocoder = new Geocoder(kunjungan.this, Locale.getDefault());
            String result = null;
    ...
    private void absen() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, api.upload_Kunjungan, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    if (success) {
                        new SweetAlertDialog(kunjungan.this, SweetAlertDialog.SUCCESS_TYPE)
                        ...
                        helper.showMsg(kunjungan.this,"Informasi",""+data,helper.WARNING_TYPE);
                    }
                    mProgressDialog.dismiss();
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d("JSONERORABSEN", "onResponse: "+e);
                    helper.showMsg(kunjungan.this, "Peringatan", "" + helper.PESAN_SERVER+e, helper.ERROR_TYPE);
                    mProgressDialog.dismiss();
                }
            }
        },
                error -> {
                    ...
                    helper.showMsg(kunjungan.this, "Peringatan", ""+helper.PESAN_KONEKSI, helper.ERROR_TYPE);
                }) {
            @Override
        ...
        if(android.os.Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT){
            if(ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED){
               ...
               mFusedLocationClient.requestLocationUpdates(mLocationRequest, locationCallback, Looper.myLooper());
                ...
                new SweetAlertDialog(kunjungan.this, SweetAlertDialog.WARNING_TYPE)
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(kunjungan.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
            }
        }
        updateLocationUI();
    ...
    public void cekFakeGps() {
        try {
            LocationUpdate gt = new LocationUpdate(kunjungan.this);
