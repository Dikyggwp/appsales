...
public class AktifitasModal extends DialogFragment {
    Context ctx;
    Button btnsubmit;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.modal_aktifitas, container, false);
        return view;
    }
    ...
    private void send_aktivitas(final Bitmap bitmap) {
